...
ban = []
cr = '*RIBAS BOT*'
vz = '*Terima Kasih Sudah Daftar Di RIBAS BOT*'
const vcard = 'BEGIN:VCARD\n' //
            + 'VERSION:3.0\n' //
            + 'FN: Ribas❤️\n' //
            + 'ORG:Creator RIBAS BOT;\n' //
            + 'TEL;type=CELL;type=VOICE;waid=6282193030283:+6282193030283 \n' //
            + 'END:VCARD'
prefix = '/'
blocked = []
limitawal = 30
...
async function starts() {
	...
	client.on('qr', () => {
		console.log(color('[','white'), color('!','red'), color(']','white'), color(' Jangan Lupa Subscribe RIBAS OFFICIAL'))
	})
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: 'Maaf Kak Fitur Ini Untuk User Mods RIBAS BOT',
					...
					userB: `「 *DAFTAR* 」\n\nMaaf Kak, Kakak Belum Terdaftar Sebagai Teman *RIBAS BOT*\nSilahkan Daftar Terlebih Dahulu , Agar Bisa Menggunakan *RIBAS BOT*\n\nCara Daftar : *${prefix}daftar Bot|18*\n\nKalau Sudah Daftar , Jangan Lupa Ketik *${prefix}rules* untuk menampilkan menu bot\n\n「 *RIBAS BOT* 」`,
			...
			const ownerNumber = ["6282193030283@s.whatsapp.net","6282193030283@s.whatsapp.net","6285934521937@s.whatsapp.net","6285934521937@s.whatsapp.net","6285934521937@s.whatsapp.net","6285934521937@s.whatsapp.net"]
			const mod = [ownerNumber,"6282193030283@s.whatsapp.net","6282193030283@s.whatsapp.net","6285934521937@s.whatsapp.net","6285220867142@s.whatsapp.net","6285281968399@s.whatsapp.net","6288705834498@s.whatsapp.net"]
			const adminbotnumber = ["6282193030283@s.whatsapp.net","6282193030283@s.whatsapp.net","6285934521937@s.whatsapp.net","6285220867142@s.whatsapp.net","6285281968399@s.whatsapp.net","6288705834498@s.whatsapp.net"]
			const frendsowner = ["6282193030283@s.whatsapp.net","6282193030283@s.whatsapp.net","6285934521937@s.whatsapp.net","6285220867142@s.whatsapp.net","6285281968399@s.whatsapp.net","6288705834498@s.whatsapp.net"]
			const premium = ["6282193030283@s.whatsapp.net","6282193030283@s.whatsapp.net","6285934521937@s.whatsapp.net","6285220867142@s.whatsapp.net","6281315995628@s.whatsapp.net","6289516155504@s.whatsapp.net","6285281968399@s.whatsapp.net","6288705834498@s.whatsapp.net"]
...
baby.sendMessage(from, onichanmp3, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
}


if (budy.includes(`assalamualaikum`)) {
tujuh = fs.readFileSync('./assets/waalaikumsalam.mp3');
...
*Jangan Lupa Untuk Donasi Agar Bot Selalu Aktif*
 https://saweria.co/rbssindo`})
                break
					...
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, '*RIBAS BOT GROUP*\n\nLink : https://chat.whatsapp.com/C1JvL9GQCRG6q2qbUVUopm ', text, { quoted: mek })
					break
					case 'funmenu':
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					...
					case 'nobg':
                                        ...
                                        anu1 = await fetchJson(`https://api.vhtear.com/removebgwithurl?link=${teks}&apikey=beli api key biar work`, {method: 'get'})
       ...
       if (!isUser) return reply(mess.only.userB)
                ...
                if (isBanned) return reply(mess.only.benned)
					...
					case 'mining':
                      ...
                      if (!isEventon) return reply(`maaf ${pushname} event mining tidak di aktifkan sama owner Ribas`)
                      if (isOwner) {
                      const one = 999999999
                      addLevelingXp(sender, one)
                      addLevelingLevel(sender, 99)
                      reply(`karena Ribas baik Bot memberikan ${one}Xp >_<`)
                      }else{
...
case 'transfer':
				...
				break
			       ...
			       case 'valxlove':
					...
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					tod = await getBuffer(`https://i.ibb.co/tcZqmw9/IMG-20210110-WA0039.jpg`)
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMIN RIBAS BOT ✨* 」\n*│+wa.me/6282193030283*╰──────*「 *RIBAS BOT* 」*────*\n\n*_JIKA INGIN MENJADI ADMIN  RIBAS BOT_*\n*_Ketik /iklan_*' })
					break
					case 'premiumcek':
					if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					sa = await getBuffer(`https://i.ibb.co/PcQ6tsB/79ac87b9358c.jpg`)
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+wa.me/6285934521937*╰──────*「 *RIBAS BOT* 」*────*\n\n*_JIKA INGIN MENJADI PREMIUM USER  RIBAS BOT_*\n*_Ketik /daftarvip*' })
					break
					case 'cekmod': 
            ...
            break
				   ...
				   if (args.length < 1) return reply('Apa yang mau dicari kak?')
					goo = body.slice(7)
					anu = await fetchJson(`https://api.vhtear.com/googleimg?query=${goo}&apikey=beli api key biar work`, {method: 'get'})
					reply(mess.wait)
                 ...
                 client.sendMessage(from, sendvir(prefix) , text, { quoted: mek })
                    ...
                    if (!isUser) return reply(mess.only.userB)
                    client.sendMessage(from, jadiselebgram(prefix), text, { quoted: mek })
                    tod = await getBuffer(`https://i.ibb.co/dgFvCdF/Screenshot-2021-02-13-15-02-37-99.png`)
                    ...
                    tod = await getBuffer(`https://i.ibb.co/RyZZLC7/Rbssbt-20210213-152942.jpg`)
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*Halo kak !ðŸ˜˜\n Btw! Jangan lupa follow Instagram Owner AkuðŸ™ˆ ig nya @rbs.420)*'})
                    break
                    case 'darkfb':
                    if (isBanned) return reply(mess.only.benned)    
                    if (!isUser) return reply(mess.only.userB)
...
break							             
			...
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
                 ...
                 tod = await getBuffer(`https://i.ibb.co/RyZZLC7/Rbssbt-20210213-152942.jpg`)
                 client.sendMessage(from, tod, image, { quoted: mek, caption: '*Halo kak !ðŸ˜˜\n Btw! Jangan lupa save Owner AkuðŸ™ˆ*'})
                 break
                     case 'fakereplay':
 ...
 if (!isOwner) return reply(mess.only.ownerB)
   ...
   if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufasfer = await getBuffer(`https://api.vhtear.com/galaxytext?text=${teks}&apikey=beli api key biar work`, {method: 'get'})
            ...
            break
                ...
                case 'pornlogo':
                  if (isBanned) return reply(mess.only.benned)    
					...
					buffer = await getBuffer(`https://api.vhtear.com/pornlogo?text1=${gbl1}&text2=${gbl2}&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					teks = body.slice(6)
					reply(mess.wait)
					loog = await getBuffer(`https://api.vhtear.com/gamelogo?text=${teks}&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/primbonjodoh?nama=arifi&pasangan=arifi&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/harijadian?tgl=${gbl16}&bln=${gbl26}&thn=${gbl36}&apikey=beli api key biar work`, {method: 'get'})
					reply(anu.result.hasil)
					break
					case 'bass':                 
       if (!isUser) return reply(mess.only.userB)
                ...
                tahta = `${body.slice(7)}`
                     if (args.length < 1) return reply('Teksnya mana gan??')
                     if (args.length > 10) return reply('karakter minimal 10')
                     buff = await getBuffer(`https://api.vhtear.com/hartatahta?text=${tahta}&apikey=beli api key biar work`, {method: 'get'})
                  ...
                  case 'unafk':
					...
					reply(mess.wait)
					pinte = body.slice(11)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pinte}&apikey=beli api key biar work`, {method: 'get'})
					reply(mess.wait)
				...
				if (!isPublic) return reply(mess.only.publikG)
                      ...
                      naon = body.slice(9)
                      reply(mess.wait)
                      anu = await fetchJson(`https://arugaz.my.id/api/textpro/neonlight?text=${naon}&apikey=beli api key biar work`, {method: 'get'})
...
if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${love}&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/metal_maker?text=${love}&apikey=beli api key biar work`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
				case 'apiteks':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/fire_maker?text=${love}&apikey=beli api key biar work`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
				case 'ffbaner':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/bannerff?title=${love}&text=ARIFI%20RAZZAQ&apikey=beli api key biar work`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
					case 'goldbutton':
					if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=metal_dark_gold&text=${tels}&apiKey=beli api key biar work`, {method: 'get'})
				...
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=blue_metal&text=${tels}&apiKey=beli api key biar work`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
				case 'textsky':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=sky_online&text=${tels}&apiKey=beli api key biar work`, {method: 'get'})
          ...
          if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferw = await getBuffer(`https://api.vhtear.com/thundertext?text=${thun}&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
                      ...
                      gl1 = gdh.split("|")[0];
                      gl2 = gdh.split("|")[1];
                      buffere = await getBuffer(`https://api.vhtear.com/silktext?text=${gl1}&text2=${gl2}&apikey=beli api key biar work`, {method: 'get'})
                      reply(mess.wait)
				...
				if (!isUser) return reply(mess.only.userB)
					...
					part = body.slice(7)
					reply(mess.wait)
					bufferu = await getBuffer(`https://api.vhtear.com/logoml?hero=miya&text=${part}&apikey=beli api key biar work`, {method: 'get'})
					client.sendMessage(from, bufferu, image, {caption: 'Nih kak', quoted: mek})
					break
				case 'shadow':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					tigaa1 = await getBuffer(`https://api.vhtear.com/blackpinkicon?text={dimen1}&apikey=beli api key biar work`)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferi = await getBuffer(`https://api.vhtear.com/romancetext?text=${tels5}&apikey=beli api key biar work`, {method: 'get'})
...
if (isBanned) return reply(mess.only.benned)    
               ...
               client.reply(from, `Waalaikumsalam wr.wb${pushname}:)`)
				...
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					client.sendMessage(from, '*pulsa :* _0821-9303-0283_\n*gopay :* _0821-9303-0283', text, { quoted: mek })
					break
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					teksj = body.slice(7)
					reply(mess.wait)
					anwu = await fetchJson(`https://api.vhtear.com/walpaper?query=${teksj}&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isPublic) return reply(mess.only.publikG)
						res = await fetchJson(`https://api.vhtear.com/randomloli&apikey=beli api key biar work`, {method: 'get'})
...
reply(mess.wait)
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isPublic) return reply(mess.only.publikG)
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/waifu?apikey=beli api key biar work`, {method: 'get'})
			...
			if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/randomwibu&apikey=beli api key biar work`, {method: 'get'})
					if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/nhentaipdfdownload?query=287167&apikey=beli api key biar work`, {method: 'get'})
					if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/mlherolist?apikey=beli api key biar work`, {method: 'get'})
		...
		anu = await fetchJson(`https://api.vhtear.com/ytdl?link=${args[0]}&apikey=beli api key biar work`, {method: 'get'})
					if (anu.error) return reply(anu.error)
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
		...
		if (args.length < 1) return reply('tag temanmu!')
			    ...
			    reply(mess.wait)
              	    if (args.length < 1) return reply('teksnya mana gan?')
                    teks = body.slice(5)
                    anu = await fetchJson(`https://api.vhtear.com/xxxsearch?query=${teks}&apikey=beli api key biar work`, {method: 'get'})
                    teks = `===============\n`
                    {
                ...
                if (isBanned) return reply(mess.only.benned)    
				    ...
				    if (!isPublic) return reply(mess.only.publikG)
				    reply(mess.wait)
                   anu = await fetchJson(`https://api.vhtear.com/cerita_sex&apikey=beli api key biar work`, {method: 'get'})
                   if (anu.error) return reply(anu.error)
          ...
          reply('Wait..')
				...
				reply(mess.wait)
				anu = await fetchJson(`https://api.vhtear.com/downloadfilm?judul=${body.slice(6)}&apikey=beli api key biar work`, {method: 'get'})
				if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply('teks nya mana om')
					kj = body.slice(12)
					anu = await fetchJson(`https://api.vhtear.com/nomerhoki?no=${kj}&apikey=beli api key biar work`, {method: 'get'})
					reply(anu.result.hasil)
					break
				case 'textscreen':
				if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply('teks nya mana om')
					telsjk = body.slice(9)
					anu = await fetchJson(`https://api.vhtear.com/textscreen?query=${telsjk}&apikey=beli api key biar work`, {method: 'get'})
			...
			if (isBanned) return reply(mess.only.benned)    
               ...
               if (data.error) return reply(data.error)
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isGroup) return reply(mess.only.group)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hewanimutlucu&apikey=beli api key biar work`, {method: 'get'})
              ...
              case 'infogempa':
                ...
                if (!isPublic) return reply(mess.only.publikG)
                   teks = body.slice(5)
                   anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/githubprofile?user=${teks}&apikey=beli api key biar work)`, {method: 'get'})
                   if (anu.error) return reply(anu.error)
				...
				case 'hackertext':
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=theme=matrix=${tels}&apiKey=beli api key biar work`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
     case 'infocuaca':
...
if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					anu = await fetchJson(`https://api.vhtear.com/tebakgambar&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
                if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/funkuis&apikey=beli api key biar work`, {method: 'get'})
					setTimeout( () => {
				...
				if (!isUser) return reply(mess.only.userB)
				if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/family100&apikey=beli api key biar work`, {method: 'get'})
					setTimeout( () => {
					client.sendMessage(from, '*➸ Jawaban :* '+anu.result.jawaban, text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
                ...
                if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/branly?query=${body.slice(9)}&apikey=beli api key biar work`, {method: 'get'})
 ...
 if (!isPublic) return reply(mess.only.publikG)
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://tobz-api.herokuapp.com/api/hug?apikey=beli api key biar work', {method: 'get'})
					if (anu.error) return reply(anu.error)
					exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(ranp)
						if (err) return reply(mess.error.stick)
 ...
 if (isBanned) return reply(mess.only.benned)    
				...
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=elang&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=naruto&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=minato&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=boruto&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hinata&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sasuke&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sakura&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
				if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=unta&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kaneki&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=ToukaKirishima&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=RizeKamishiro&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=akiramado&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=itori&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kurumitokisakikawai&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=Nakanomiku&apikey=beli api key biar work`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=remrezero&apikey=beli api key biar work`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=ramrezero&apikey=beli api key biar work`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply(mess.search)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hewan&apikey=beli api key biar work`, {method: 'get'})
					reply(mess.wait)
					var pin = JSON.parse(JSON.stringify(anu.result));
					var trest =  pin[Math.floor(Math.random() * pin.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=lolikawai&apikey=beli api key biar work`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=waifukawai&apikey=beli api key biar work`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=nekoanimekawai&apikey=beli api key biar work`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isNsfw) return reply('❌ *FALSE* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=animehentai&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=loli&apikey=beli api key biar work`, {method: 'get'})
                ...
                if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply(mess.search)
					pinte = body.slice(11)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pin}&apikey=beli api key biar work`, {method: 'get'})
					reply(mess.wait)
					var pin = JSON.parse(JSON.stringify(anu.result));
					var trest =  pin[Math.floor(Math.random() * pin.length)];
					pine = await getBuffer(trest)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=bokep&apikey=beli api key biar work`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
		...
		;			client.sendMessage(from, thumb, image, {quoted: mek, caption: teks})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					anu = await fetchJson(`https://https://api.vhtear.com/youtube?query=$ytsearch1}&apikey=beli api key biar work`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					teks = '=================\n'
				...
				if (isBanned) return reply(mess.only.benned)    
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/tiktokdl?link=${args[0]}&apikey=beli api key biar work`, {method: 'get'})
					if (anu.error) return reply(anu.error)
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=metalic_text_glow&text=${teks}&apikey=beli api key biar work`, {method: 'get'})
                                        client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
                                case '8bit':
                                          if (isBanned) return reply(mess.only.benned)    
                    ...
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=bit8&text=${teks}&text=${teks}&apikey=BotWeA`, {method: 'get'})
			     	...
			     	break
                                ...
                                case 'fml2':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        data = await fetchJson(`https://tobz-api.herokuapp.com/randomfmylife?apikey=beli api key biar work`, {method: 'get'})
                                        hasil = `*Fuck My Life*\n${data.result}`
                                        reply(hasil)
                                        break
				case 'tiktokstalk':
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${teks}&apikey=beli api key biar work`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			     case 'airtext':
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/water_maker?text=${teks}&apikey=beli api key biar work`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			     case 'kuncitext':
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/padlock?text1=${teks}&text2=${teks}&apikey=beli api key biar work`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			    case 'shorturl':
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
			if (!isPublic) return reply(mess.only.publikG)
                    anu = await fetchJson(`https://tobz-api.herokuapp.com/api/shorturl?url=${body.slice(10)}&apikey=beli api key biar work`)
			        hasil = `${anu.result}`
			        reply(hasil)
			        break
			    case 'infonotlp':
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
					...
					ige = body.slice(9)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomobil?merk=${ige}&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					ft1 = body.slice(11)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomotor?merk=${ft1}&apikey=beli api key biar work`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					kuji = body.slice(7)
					reply(mess.wait)
					anu = await getBuffer(`https://api.vhtear.com/playstore?query={kuji}&apikey=beli api key biar work`, {method: 'get'})
 ...
 if (!isOwner) return reply(mess.only.ownerB)
			...
			if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/logoff?hero=alok&text=${tels}&apikey=beli api key biar work`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					 client.sendMessage(from, buffer, image, {quoted: mek})
					break
				case 'tstiker':
			...
			if (!isPublic) return reply(mess.only.publikG)
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘  *RIBAS BOT* 〙', members_id, true)
					break
				case 'clearall':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
	...
	.then(() => {client.sendMessage(from, options, text)})
				...
				//frendowner
				case `addadmin`:
                   if (!isOwner) return reply('Perintah ini hanya bisa di gunakan oleh Owner RIBAS BOT!', id)
                   for (let i = 0; i < mentionedJidList.length; i++) {
                   adminNumber.push(mentionedJidList[i])
                   fs.writeFileSync('./lib/database/admin.json', JSON.stringify(adminNumber))
                   reply('Success Menambahkan Admin RIBAS BOT!')
				   }
                   break
